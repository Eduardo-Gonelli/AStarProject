...
{    
    public List<AStarNodeOpt> openList;   // lista de nós abertos que são candidatos a fazer parte do caminho    
    public List<AStarNodeOpt> closedList; // lista de nós fechados que já foram visitados    
    public List<AStarNodeOpt> path;       // lista de nós que formam o caminho    
    public List<AStarNodeOpt> grid;       // lista de todos os nós do grid
    public AStarNodeOpt startNode;        // nó inicial
    public AStarNodeOpt endNode;          // nó final
    public AStarNodeOpt currentNode;      // nó atual que está sendo avaliado
    ...
    void Start()
    {
        ...
        grid = new List<AStarNodeOpt>(FindObjectsOfType<AStarNodeOpt>());
